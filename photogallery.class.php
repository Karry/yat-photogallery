...
class Album {
  ...
  function __construct($gallery, $dir) {
    ...
    $this->baseDir = preg_replace("/\\/$/i", "", trim($this->gallery->baseDir() . DIRECTORY_SEPARATOR . $this->dir));
  }
...
class Photogallery {
   ...
   */
  function __construct($baseDir, $baseUrlPrefix, $albumUrlPrefix = "", $webRootDir = "", $metadataCacheDir = null) {
    $this->baseUrl = $baseUrlPrefix;
    $this->albumUrlPrefix = $albumUrlPrefix;
    $this->baseDir = $baseDir;
    $this->webRootDir = $webRootDir;
    $this->metadataCacheDir = $metadataCacheDir;
    if ($this->metadataCacheDir == null) {
      $this->metadataCacheDir = $webRootDir . "/cache/photoMetadata";
    }
